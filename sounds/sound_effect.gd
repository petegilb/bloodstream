...
# sourced/referenced: https://github.com/Aarimous/AudioManager/blob/main/SoundEffectSetting.gd
...
@export var type: SOUND_EFFECT_TYPE = SOUND_EFFECT_TYPE.DEFAULT ## The unique sound effect in the [enum SOUND_EFFECT_TYPE] to associate with this effect. Each SoundEffect resource should have it's own unique [enum SOUND_EFFECT_TYPE] setting.
